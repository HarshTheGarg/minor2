  ...
  while True:
    ...
    if hands:
      for hand_lands, handedness in zip(hands, res.multi_handedness):
        ...
        if mode == 2:
          if gesture == "pinch":
            # print(prevPointerLoc[0] - pointerLoc[0])
            # print(prevPointerLoc[0] - pointerLoc[0], prevPointerLoc[1] - pointerLoc[1])
            pyautogui.drag(pointerLoc[0] - prevPointerLoc[0], pointerLoc[1] - prevPointerLoc[1])
            # pass
          elif gesture == "point":
            pyautogui.moveTo(pointerLoc[0], pointerLoc[1])
          elif gesture == "open":
            pyautogui.click(pointerLoc[0], pointerLoc[1])
            pass
          # print(pointerLoc)
        ...
        prevPointerLoc[0] = pointerLoc[0]
        prevPointerLoc[1] = pointerLoc[1]
